...
feature "Customers", type: :feature do
  ...
  scenario 'Não permite cadastrar um cliente inválido' do
    visit(new_customer_path)
    click_on('Criar Cliente')
  ...
  scenario 'Click no link Mostrar' do
    customer = create(:customer)
  ...
  scenario 'Click no link Editar na Index' do
    customer = create(:customer)
    visit(customers_path)
  ...
  scenario 'Click no link delete do cliente', js: true do
    customer = create(:customer)
